...
.tab_con img { width: 300px; height: 350px; padding-top: 20px; }
.tab_ra { display:none; }
...
<div id="page1">
			<div style="position: relative;">
				<div>
					<img src="${path0 }/resources/images/ganghwa4.jpg" alt="main photo">
				</div>
		</div>
		<ul>
            <li><img src="${path0 }/resources/images/logomodi.png" alt="로고" class="logo1"></li>
		...
		<div class="dropup">
			<a class="dropbtn">
				<img src="${path0 }/resources/images/화살표1.png" alt="화살표" style="width: 64px; height: 64px; stroke: #fff;">
			</a>
			<div class="dropup-content">
				...
				<ul>
					<li style="border-bottom: 2px solid #000;"><a href="${path0 }/GetTrafficList.do" class="dp1">강화정보</a></li>
					<li><a href="${path0 }/GetTrafficList.do">교통정보</a></li>
					<li><a href="${path0 }/traffic/parking.jsp">공영 주차장</a></li>
					<li><a href="${path0 }/traffic/come.jsp">오시는 길</a></li>
				</ul>
				<ul>
					<li style="border-bottom: 2px solid #000;"><a href="${path0 }/NoticeList.do" class="dp1">강화소통</a></li>
					<c:choose>
		...
		<div class="circle">
			<ul id="tab1">
				...
				<li class="item1">
					...
					<label for="tab_ra1" class="tab_btn"><img src="${path0 }/resources/images/n1.png" alt="n1"></label>
					<div class="tab_con">
						<div class="tab_img">
							<img src="${path0 }/resources/images/nadeulgil10.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
								<img src="${path0 }/resources/images/mark.png" alt="즐겨찾기" class="mark">
							</div>
						</div>
						<div class="tab_img">
							<img src="${path0 }/resources/images/nadeulgil11.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
					...
					<div class="tab_img">
							<img src="${path0 }/resources/images/nadeulgil12.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
				...
				<li class="item2">
					...
					<label for="tab_ra2" class="tab_btn"><img src="${path0 }/resources/images/dol.png" alt="고인돌"></label>
					<div class="tab_con">
						<div class="tab_img">
							<img src="${path0 }/resources/images/hisexperi01.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
						...
						<div class="tab_img">
							<img src="${path0 }/resources/images/hisexperi02.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
						...
						<div class="tab_img">
							<img src="${path0 }/resources/images/hisexperi03.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
				...
				<li class="item3">
					...
					<label for="tab_ra3" class="tab_btn"><img src="${path0 }/resources/images/play.png" alt="체험"></label>
					<div class="tab_con">
						<div class="tab_img">
							<img src="${path0 }/resources/images/repoex01.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
							...
							<img src="${path0 }/resources/images/repoex02.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
							...
							<img src="${path0 }/resources/images/repoex03.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
				...
				<li class="item4">
					...
					<label for="tab_ra4" class="tab_btn"><img src="${path0 }/resources/images/island.png" alt="섬"></label>
					<div class="tab_con">
						<div class="tab_img">
							<img src="${path0 }/resources/images/islandexperi01.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
						...
						<div class="tab_img">
							<img src="${path0 }/resources/images/islandexperi02.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
						...
						<div class="tab_img">
							<img src="${path0 }/resources/images/islandexperi03.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
				...
				<li class="item5">
					...
					<label for="tab_ra5" class="tab_btn"><img src="${path0 }/resources/images/mount.png" alt="산"></label>
					<div class="tab_con">
						<div class="tab_img">
							<img src="${path0 }/resources/images/mountexperi01.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
						...
						<div class="tab_img">
							<img src="${path0 }/resources/images/mountexperi02.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
						...
						<div class="tab_img">
							<img src="${path0 }/resources/images/mountexperi03.jpg" alt="탭이미지" >
							<div class="sub_img">
								<img src="${path0 }/resources/images/heart.png" alt="하트" class="heart">
								<img src="${path0 }/resources/images/balloon.png" alt="말풍선" class="balloon">
								<img src="${path0 }/resources/images/paper.png" alt="종이비행기" class="paper">
